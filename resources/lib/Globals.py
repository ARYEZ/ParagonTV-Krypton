...
if ADDON.getSetting("ChannelSharing") == "true":
    ...
    LOCK_LOC = xbmc.translatePath(
        os.path.join(ADDON.getSetting("SettingsFolder"), "cache" + "/")
    )
...
TIME_BAR = "ptvTimeBar.png"
BUTTON_NO_FOCUS = "ptvButtonNoFocus.png"
BUTTON_FOCUS = "ptvButtonFocus.png"
